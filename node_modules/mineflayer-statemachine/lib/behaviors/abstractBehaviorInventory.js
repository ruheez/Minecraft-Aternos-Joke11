...
exports.AbstractBehaviorInventory = void 0;
 ...
 */
class AbstractBehaviorInventory {
    constructor(bot, targets) {
        this.stateName = 'inventory';
        this.active = false;
        this.bot = bot;
    ...
    getEquipDestination(item) {
        if (this.isHelmet(item))
            return 'head';
        if (this.isChestplate(item))
            return 'torso';
        if (this.isLeggings(item))
            return 'legs';
        if (this.isBoots(item))
            return 'feet';
    ...
    isHelmet(item) {
        const id = item.type;
        if (id === this.mcData.itemsByName.leather_helmet.id)
            return true;
        if (id === this.mcData.itemsByName.iron_helmet.id)
            return true;
        if (id === this.mcData.itemsByName.golden_helmet.id)
            return true;
        if (id === this.mcData.itemsByName.diamond_helmet.id)
            return true;
        if (id === this.mcData.itemsByName.turtle_helmet.id)
            return true;
        return false;
    }
    /**
    ...
    isChestplate(item) {
        const id = item.type;
        if (id === this.mcData.itemsByName.leather_chestplate.id)
            return true;
        if (id === this.mcData.itemsByName.iron_chestplate.id)
            return true;
        if (id === this.mcData.itemsByName.golden_chestplate.id)
            return true;
        if (id === this.mcData.itemsByName.diamond_chestplate.id)
            return true;
        return false;
    }
    /**
    ...
    isLeggings(item) {
        const id = item.type;
        if (id === this.mcData.itemsByName.leather_leggings.id)
            return true;
        if (id === this.mcData.itemsByName.iron_leggings.id)
            return true;
        if (id === this.mcData.itemsByName.golden_leggings.id)
            return true;
        if (id === this.mcData.itemsByName.diamond_leggings.id)
            return true;
        return false;
    }
    /**
    ...
    isBoots(item) {
        const id = item.type;
        if (id === this.mcData.itemsByName.leather_boots.id)
            return true;
        if (id === this.mcData.itemsByName.iron_boots.id)
            return true;
        if (id === this.mcData.itemsByName.golden_boots.id)
            return true;
        if (id === this.mcData.itemsByName.diamond_boots.id)
            return true;
        return false;
    }
    /**
       ...
       */
    isOffhandUsable(item) {
        if (this.isBlock(item))
            return true;
        if (this.isFood(item))
            return true;
        const id = item.type;
        if (id === this.mcData.itemsByName.bow.id)
            return true;
        if (id === this.mcData.itemsByName.egg.id)
            return true;
        if (id === this.mcData.itemsByName.lingering_potion.id)
            return true;
        if (id === this.mcData.itemsByName.snowball.id)
            return true;
        if (id === this.mcData.itemsByName.splash_potion.id)
            return true;
        if (id === this.mcData.itemsByName.trident.id)
            return true;
        if (id === this.mcData.itemsByName.crossbow.id)
            return true;
        if (id === this.mcData.itemsByName.bucket.id)
            return true;
        if (id === this.mcData.itemsByName.ender_pearl.id)
            return true;
        if (id === this.mcData.itemsByName.fishing_rod.id)
            return true;
        if (id === this.mcData.itemsByName.flint_and_steel.id)
            return true;
        if (id === this.mcData.itemsByName.lead.id)
            return true;
        if (id === this.mcData.itemsByName.shears.id)
            return true;
        if (id === this.mcData.itemsByName.shield.id)
            return true;
        if (id === this.mcData.itemsByName.potion.id)
            return true;
        if (id === this.mcData.itemsByName.totem_of_undying.id)
            return true;
        if (id === this.mcData.itemsByName.stone_hoe.id)
            return true;
        if (id === this.mcData.itemsByName.iron_hoe.id)
            return true;
        if (id === this.mcData.itemsByName.golden_hoe.id)
            return true;
        if (id === this.mcData.itemsByName.diamond_hoe.id)
            return true;
        if (id === this.mcData.itemsByName.stone_shovel.id)
            return true;
        if (id === this.mcData.itemsByName.iron_shovel.id)
            return true;
        if (id === this.mcData.itemsByName.golden_shovel.id)
            return true;
        if (id === this.mcData.itemsByName.diamond_shovel.id)
            return true;
        if (id === this.mcData.itemsByName.stone_axe.id)
            return true;
        if (id === this.mcData.itemsByName.iron_axe.id)
            return true;
        if (id === this.mcData.itemsByName.golden_axe.id)
            return true;
        if (id === this.mcData.itemsByName.diamond_axe.id)
            return true;
        if (id === this.mcData.itemsByName.map.id)
            return true;
        if (id === this.mcData.itemsByName.clock.id)
            return true;
        if (id === this.mcData.itemsByName.compass.id)
            return true;
        if (id === this.mcData.itemsByName.firework_rocket.id)
            return true;
        return false;
    }
    /**
...
exports.AbstractBehaviorInventory = AbstractBehaviorInventory;
